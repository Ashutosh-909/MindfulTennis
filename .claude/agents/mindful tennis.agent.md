...
├── domain/
│   ├── model/                        // Clean domain models (no Room/Firestore annotations)
...
**User**: `id` (Firebase UID), `email`, `displayName`, `photoUrl`, `createdAt`, `timeZone`
...
- Do NOT store auth tokens manually — Firebase SDK handles this.
